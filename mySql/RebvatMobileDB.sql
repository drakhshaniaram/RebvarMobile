...
DROP SCHEMA IF EXISTS `shahabco_RebvarMobileDB` ;
CREATE SCHEMA IF NOT EXISTS `shahabco_RebvarMobileDB` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
SHOW WARNINGS;
USE `shahabco_RebvarMobileDB` ;
