...
//_________________________ loading XML file and parsing it to .main div. _______________________________________
   ...
   $(CAT_OBJECT.Categorys).each(function (index, cat_element) {
      ...
      if (Number(cat_element.has_title) === 0) { // ساخت تک صفحه بدون لیست عنوان
         ...
         $(CAT_OBJECT.Articles).each(function (index, art_element) {
            ...
            comments = "";
            answer = "";
         }); //end of extracting categorys that had no list
...
//__________________________________________ Show the Splash Screen___________________________________________
//<![CDATA[ 
$(window).load(function () {
   ...
   function hideSplash() {
      $.mobile.changePage("#mainPage", "flip");
      $(".splash").remove();
   }
